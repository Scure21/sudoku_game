...
var Board = (function (_super) {
    ...
    Board.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "board-container" },
            React.createElement("div", { className: "board" }, subgridRows.map(function (row) { return subgridCols.forEach(function (col) {
                return React.createElement(Square_1.default, { value: row, className: "square", id: row + "-" + col, key: col });
            }); }))));
    };
    return Board;
}(React.Component));
...
//# sourceMappingURL=app.13c758526386d9a8234c.hot-update.js.map