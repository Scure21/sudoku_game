...
var Subgrid = (function (_super) {
    ...
    Subgrid.prototype.render = function () {
        var rows = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        var columns = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        return (React.createElement("div", { className: "subgrid" }, rows.map(function (row) { return columns.map(function (col) {
            return React.createElement(Square_1.default, { value: row, className: "subgrid", id: row + "-" + col, key: col });
        }); })));
    };
    return Subgrid;
}(React.Component));
...
//# sourceMappingURL=app.8bfbd430ac558d6877dd.hot-update.js.map