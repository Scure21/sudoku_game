...
var Board = (function (_super) {
    ...
    Board.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "board-container" },
            React.createElement("div", { className: "board-border" }, rows.map(function (row) { return columns.map(function (col) { return React.createElement(Square_1.default, { value: row, className: "square", id: row + "-" + col, key: col }); }); }))));
    };
    return Board;
}(React.Component));
...
//# sourceMappingURL=app.836d39edf584ef18d4bd.hot-update.js.map