...
var Subgrid = (function (_super) {
    ...
    Subgrid.prototype.render = function () {
        var rows = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        var columns = [1, 2, 3, 4, 5, 6, 7, 8, 9];
        return (React.createElement("div", { className: "square-container" }, rows.map(function (row) { return columns.map(function (col) { return React.createElement(Square_1.default, { value: row, className: "square", id: row + "-" + col, key: col }); }); })));
    };
    return Subgrid;
}(React.Component));
...
//# sourceMappingURL=app.957fa552998b8b84cb87.hot-update.js.map