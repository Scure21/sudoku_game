...
var Board = (function (_super) {
    ...
    Board.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "board-container" },
            React.createElement("div", { className: "board" }, rows.map(function (row) { return columns.map(function (col) { return React.createElement(Square_1.default, { value: row, className: "square", id: row + "-" + col, key: col }); }); }))));
    };
    return Board;
}(React.Component));
...
//# sourceMappingURL=app.9ea981fe0f0a5026be2b.hot-update.js.map